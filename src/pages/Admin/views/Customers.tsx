...
export const Customers: React.FC = () => {
    ...
    const fetchCustomers = async () => {
        try {
            ...
            console.error("Error fetching customers:", getApiErrorMessage(error, "Failed to load"));
        } finally {
            setLoading(false);
        }
    };
                        ...
                        <TableBody>
                            {customers.map((customer) => (
                                <TableRow key={customer.id}>
                                    ...
                                    <TableCell>{getFullAddress(customer.address)}</TableCell>
                                    <TableCell>
                                        <Button variant="outlined" color="error" size="small" onClick={() => handleDelete(customer.id)}>
                                            Delete
                                        </Button>
                                    </TableCell>
                                </TableRow>
